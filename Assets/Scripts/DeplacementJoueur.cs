...
public class DeplacementJoueur : MonoBehaviour
{
    ...
    public float positionZoneMinY = -8.1f;
    public float positionZoneMaxY = 8f;
    ...
    void Update()
    {
        ...
        transform.position = new Vector2(Mathf.Clamp(transform.position.x, -16, 16), Mathf.Clamp(transform.position.y, -9, 8));
